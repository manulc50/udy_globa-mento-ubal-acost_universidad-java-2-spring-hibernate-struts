...
public class HolaMundoHibernate {
	...
	public static void main(String args[]) {
		...
		// Creamos el Entity Manager Factory a partir de nuestra unidad de persistencia "HibernateEjemplo1" definida en el archivo de configuración "persistence.xml"
